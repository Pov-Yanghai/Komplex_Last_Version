        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="rounded-md bg-blue-50 p-3 text-xs space-y-1">
            ...
            <p className="text-blue-800">
              <strong>Admin:</strong> admin@komplex.edu
            </p>
            <p className="text-blue-800">
              <strong>Educator:</strong> educator@komplex.edu
            </p>
            <p className="text-blue-800">
              <strong>Student:</strong> student@komplex.edu
            </p>
            <p className="text-blue-800">
              <strong>Analyst:</strong> analyst@komplex.edu
            </p>
            <p className="text-blue-700 mt-1 italic">Password: any value</p>
          </div>
